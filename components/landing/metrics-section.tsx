...
const metrics = [
  {
    ...
    suffix: "%",
    prefix: "",
    label: "Task completion speed increase",
    company: "LINEAR",
  },
  {
    value: 10,
    suffix: "x",
    prefix: "",
    label: "Faster workflow iteration",
    company: "NOTION",
  },
  {
    value: 70,
        ...
        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-8 mb-16 lg:mb-24">
          <div>
            ...
            >
              Real results.
              <br />
              <span className="text-muted-foreground">From real teams.</span>
            </h2>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-px bg-foreground/10">
          {metrics.map((metric, index) => (
            ...
            >
              ...
              {"company" in metric && (
                <div className="mt-1 text-xs font-mono text-muted-foreground">{metric.company}</div>
              )}
            </div>
          ))}
        </div>
