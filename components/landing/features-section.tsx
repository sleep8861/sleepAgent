...
const features = [
  {
    ...
    description: "Drag-and-drop multi-agent workflows, no code required. Design complex agent pipelines visually and deploy in minutes.",
    visual: "deploy",
  },
  {
    number: "02",
    title: "Multi-Model Support",
    description: "Connect any LLM and coordinate agent-to-agent handoffs seamlessly. Mix and match models for each step of your workflow.",
    visual: "ai",
  },
  {
    number: "03",
    title: "Enterprise Security",
    description: "RBAC, audit logs, and private deployments for full control. Your data and agent interactions stay encrypted and compliant.",
    visual: "security",
  },
  {
    number: "04",
    title: "Smart Automation",
    description: "Trigger workflows via schedule, webhook, or API calls. Set up end-to-end automation that runs reliably at any scale.",
    visual: "collab",
  },
];
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        <div className="mb-16 lg:mb-24">
          ...
          >
            Everything you need.
            <br />
            <span className="text-muted-foreground">To orchestrate AI at scale.</span>
          </h2>
        </div>
